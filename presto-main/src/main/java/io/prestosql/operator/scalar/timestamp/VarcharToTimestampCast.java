...
public final class VarcharToTimestampCast
{
    ...
    @VisibleForTesting
    public static long castToShortTimestamp(int precision, String value, Function<String, ZoneId> zoneId)
    {
    ...
    @VisibleForTesting
    public static LongTimestamp castToLongTimestamp(int precision, String value, Function<String, ZoneId> zoneId)
    {
